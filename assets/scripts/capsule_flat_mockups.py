...
# these render on models with style-ids; force the Flat group instead
FLAT_GROUP={"beach-dress","bodycon","one-piece","swim-trunk","resort-short"}
...
for it in prods:
    ...
    if slug in FLAT_GROUP:
        body["option_groups"]=["Flat"]
    else:
        sid=front_style(cid)
